...
<head>
    <title>BLUELINE VACCINE - Dashboard</title>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          ...
                                          <h6 class="m-b-0" style="color: #061065;">Welcome to BlueLine Vaccine Management System</h6>
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Dshboard</a> 
